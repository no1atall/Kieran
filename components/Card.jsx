...
const Card = (data, index) => {
  return (
    <div className=" mx-auto sm:mx-4 mt-12 min-h-4/5 sm:w-[40%] lg:w-[25%]  flex flex-col   items-center sm:items-start justify-between">
        <Image className="" alt={data.alt} src={data.img} height="200px" width="300px"></Image>
      ...
      <button className="transition duration-500 ease-in-out my-6 mx-2 px-4 py-2 bg-primary hover:bg-green-500 
