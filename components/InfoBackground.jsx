...
const InfoBackground = ({ phone, email }) => {
  return (
    <div>
      <div className="bg-gray-200 rounded-full w-5/6 mx-auto my-4 flex items-center">
        <span className="bg-primary rounded-full w-20 h-20 flex justify-center items-center">
          {phone.icon}
        </span>
